...
* :warning: This version includes a change to the storage library makes it very difficult to go back to an earlier version after upgrade to this version without losing data.
* Update go: 1.24.5
